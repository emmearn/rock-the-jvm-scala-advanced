...
//
//  class Cat extends Animal {
//    override def breed: List[Cat] = ??? // List[+A]
//  }
//
//  class Dog extends Animal {
//    override def breed: List[Cat] = ??? // List[+A] - wrong
//  }
...
//
////  class Crocodile extends Animal[Dog] {
////    override def breed: List[Animal[Dog]] = ??? // doesn't works
////  }
//
//  class Cat extends Animal[Cat] {
//    override def breed: List[Animal[Cat]] = ??? // List[Cat]
...
//  // cat.breed
  ...
  object Dog {
    implicit object DogAnimal extends Animal[Dog] {
      override def breed(a: Dog): List[Dog] = List(a)
    }
  }
